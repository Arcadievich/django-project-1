...
## Установка
- Установите [Python](https://www.python.org/downloads/) версии 3.11.8
- Клонируйте репозиторий на свой ПК
- Создайте виртуальную среду Python
- Перейдите в директорию приложения и используйте команду, указанную ниже для установки необходимых библиотек
```powershell
...
Теперь приложение готово к запуску из виртуальной среды командой 
```powershell
python manage.py runserver
```

## Команды
- `load_place` для добавления на сайт места из json-файла. Пример:

```powershell
python manage.py load_place ссылка_на_json_файл
```
